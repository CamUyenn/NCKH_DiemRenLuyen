      ...
      <table className="xemchitiet_students-table">
        ...
        <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        {item.loai === "radio" && (
                          <input
                            type="radio"
                            name={`bcs-${item.mucCha}`}
                            checked={
                              bcsSelectedValues[item.mucCha || ""]?.includes(
                                item.muc
                              ) || false
                            }
                            onChange={() => {
                        ...
                        {item.loai === "counter" && (
                          <input
                            type="number"
                            value={bcsSelectedValues[item.muc]?.[0] || ""}
                            onChange={(e) => {
                              setBcsSelectedValues((prev) => ({
                                ...prev,
          ...
          <tr className="rank-row">
            ...
            <td style={{ fontWeight: "bold" }}>
              {/* chỗ này sẽ hiển thị tổng điểm BCS (nếu bạn tính riêng), 
        hoặc để trống nếu chưa cần */}
            </td>
      ...
      <div className="xemchitiet_students-buttons">
        ...
        <button
          onClick={() => {
            ...
            // Cập nhật điểm BCS cho sinh viên đang xem
