export interface Diem {
  ...
  loai: "checkbox" | "radio" | "none"| "counter"; // Loại mục
  noiDung: string;
...
export const diemData: Diem[] = [
  ...
  { muc: "1", mucLevel: 2, mucCha: "I", loai: "none", noiDung: "Kết quả học tập (Chọn 1 tiêu chí phù hợp)" },
  ...
  { muc: "2", mucLevel: 2, mucCha: "I", loai: "none", noiDung: "Hoạt động nghiên cứu khoa học, thi Olympic (0-5đ)" },
  ...
  { muc: "3", mucLevel: 2, mucCha: "I", loai: "none", noiDung: "Ý thức học tập" },
  ...
  { muc: "a", mucLevel: 3, mucCha: "4", loai: "counter", noiDung: "Vi phạm quy chế thi bị khiển trách", diem: "-4đ/lần" },
  { muc: "b", mucLevel: 3, mucCha: "4", loai: "counter", noiDung: "Vi phạm quy chế thi bị cảnh cáo", diem: "-6đ/lần" },
  { muc: "c", mucLevel: 3, mucCha: "4", loai: "counter", noiDung: "Vi phạm quy chế thi bị đình chỉ học phần", diem: "-10đ/lần" },
  ...
  { muc: "7", mucLevel: 2, mucCha: "II", loai: "counter", noiDung: "Vắng tựu trường, sinh hoạt lớp, đi học trễ... vi phạm nội quy", diem: "-5đ/lần" },
  { muc: "8", mucLevel: 2, mucCha: "II", loai: "counter", noiDung: "Vi phạm nội quy nhà trường bị lập biên bản", diem: "-10đ/lần" },
  ...
  { muc: "1", mucLevel: 2, mucCha: "III", loai: "counter", noiDung: "Tham gia các hoạt động của khoa, trường (không quá 15đ)", diem: "+3đ/lần" },
  ...
  { muc: "6", mucLevel: 2, mucCha: "III", loai: "counter", noiDung: "Không tham gia hoạt động bị trừ điểm (theo danh sách ban cán sự)", diem: "-5đ/lần" },
  ...
  { muc: "3", mucLevel: 2, mucCha: "IV", loai: "counter", noiDung: "Tham gia các hoạt động nhân đạo, an toàn giao thông, lao động công ích", diem: "+3đ/lần" },
  { muc: "4", mucLevel: 2, mucCha: "IV", loai: "counter", noiDung: "Vi phạm pháp luật (chưa đến mức chịu TNHS)", diem: "-10đ/lần" },
